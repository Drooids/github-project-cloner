...
#Â results in those big files being present in the git history. This is, among
#Â other things, due to some pull requests I have in that repository and which
#Â reference those big files. I contacted GitHub about this, but there seems to
